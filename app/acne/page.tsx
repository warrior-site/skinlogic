...
export default async function AcnePage() {
  ...
  // 2. Direct filter for Acne (safely guarding against undefined values)
  const products = allProducts ? allProducts.filter(
    (p) => p?.problem?.toLowerCase() === 'acne'
  ) : []
  ...
  return (
    <div
      ...
      style={{
        ...
        fontFamily: "'Inter', sans-serif",padding:"0.5rem"
      }}
    >
      <NavigationButtons />
      ...
      <div className="relative max-w-5xl mx-auto px-6 pt-32 pb-24 sm:pt-48 sm:pb-40 text-center"style={{padding:"0.5rem"}} >
        {/* Glow effect */}
        <div style={{margin:"0.5rem"}} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-[rgba(20,255,120,0.07)] blur-[140px] rounded-full pointer-events-none" />
        
        <p className="animate-fade-up text-xs font-semibold uppercase tracking-[0.3em] text-neutral-400 mb-8">
          Protocol 01 &middot; Acne Vulgaris
        </p>

        <h1 className="animate-fade-up font-display text-5xl sm:text-7xl font-light tracking-tight mb-10 text-[var(--text-dark)] leading-tight no-underline">
          Acne &amp; <em className="text-[var(--sage)] font-display not-italic font-normal">Pimples</em>
        </h1>
        ...
        <p className="animate-fade-up text-neutral-600 max-w-3xl mx-auto text-lg sm:text-xl leading-relaxed [animation-delay:200ms] font-light">
          A clinical approach to follicular clearance. By targeting the four pillars of acne—sebum, hyperkeratosis, bacteria, and inflammation—we restore the skin{"'"}s natural equilibrium without compromising the acid mantle.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="animate-fade-up p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed">
              Acne begins deep within the sebaceous follicle. When sebum oxidizes and mixes with trapped corneocytes, it creates a comedone—the precursor to all inflammatory breakouts.
            </p>
          </div>
          ...
          <div className="animate-fade-up [animation-delay:100ms] p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed mb-4">
              We prioritize ingredients with high lipophilic affinity to ensure penetration through oil-clogged pores.
            </p>
            <div className="flex flex-wrap gap-2">
              {['BHA', 'Retinoids', 'Azelaic Acid', 'Zinc PCA'].map(tag => (
          ...
          <div className="animate-fade-up [animation-delay:200ms] p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            <h3 className="text-xs font-bold tracking-widest uppercase text-[var(--sage)] mb-6">Barrier Safety</h3>
            <p className="text-neutral-500 text-sm leading-relaxed">
              True clearance requires a healthy pH. Over-cleansing triggers &quot;reactive seborrhea,&quot; where the skin produces even more oil to compensate for being stripped.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-2">
                <h2 className="font-display text-3xl font-light text-[var(--text-dark)]">The Acne Protocol</h2>
                <p className="text-neutral-500 text-sm">Curated formulations optimized for active pore clearance.</p>
              </div>
              <div className="text-[10px] uppercase tracking-widest text-neutral-400 font-bold bg-white px-4 py-2 rounded-full border border-neutral-200 shadow-sm">
                Slide to explore all products &rarr;
              </div>
            </div>
      ...
      <section className="py-32 max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="text-neutral-500 text-lg leading-relaxed font-light mb-8">
          The goal of an anti-acne routine isn{"'"}t to &quot;dry out&quot; the skin, but to normalize its behavior. By replacing harsh sulfates with biomimetic surfactants and using encapsulated actives, we target C. acnes bacteria without causing the redness and peeling typically associated with clinical treatments.
        </p>
      ...
      {PROBLEMS && PROBLEMS.length > 0 && (
        <section className="py-32 border-t border-neutral-200/40 bg-white" style={{width:"20vw", margin:"0 auto", alignItems:"center", justifyContent:"center", display:"flex", flexDirection:"column"}}>
