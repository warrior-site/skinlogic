...
export default async function DarkCirclesPage() {
  ...
  // 2. Direct filter for periorbital concerns
  const products = allProducts ? allProducts.filter(
    (p) => p?.problem?.toLowerCase() === 'dark-circles' || p?.problem?.toLowerCase() === 'eyes'
  ) : []
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 pt-32 pb-24 sm:pt-48 sm:pb-40 text-center" style={{ padding: "0.5rem" }}>
        ...
        <p className="animate-fade-up text-xs font-semibold uppercase tracking-[0.3em] text-neutral-400 mb-8">
          Protocol 05 &middot; Periorbital Vascularization &amp; Melanin Control
        </p>
        ...
        <h1 className="animate-fade-up font-display text-4xl sm:text-7xl font-light tracking-tight mb-10 text-[var(--text-dark)] leading-tight no-underline">
          Dark Circles &amp; <em className="text-[var(--sage)] font-display not-italic font-normal">Puffy Eyes</em>
        </h1>
        ...
        <p className="animate-fade-up text-neutral-600 max-w-3xl mx-auto text-lg sm:text-xl leading-relaxed [animation-delay:200ms] font-light">
          A clinical approach to periorbital restoration. By treating multi-pathway origin points—vascular pooling, hyperpigmentation, dermal thinning, and lymphatic stagnation—we rebuild structural density and clarity.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="animate-fade-up p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed">
              The periorbital layer is the thinnest skin on the body. Darkness stems from mixed etiologies: dermal melanin deposition, stasis of the subcutaneous capillaries revealing bluish vessels, or structural shadowing from fat pad displacement.
            </p>
          </div>
          ...
          <div className="animate-fade-up [animation-delay:100ms] p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed mb-4">
              We isolate compounds capable of modifying vascular diameter, stimulating structural collagen, and down-regulating excessive melanocyte transfer.
            </p>
            <div className="flex flex-wrap gap-2">
              {['Caffeine', 'Vitamin K', 'Retinol', 'Hyaluronic Acid'].map(tag => (
          ...
          <div className="animate-fade-up [animation-delay:200ms] p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed">
              True correction requires increasing skin thickness. Concealers mask symptoms, but long-term intervention demands cellular turn-over acceleration to build up the supportive extracellular matrix and hide underlying veins.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-2">
                <h2 className="font-display text-3xl font-light text-[var(--text-dark)]">The Eye Contour Protocol</h2>
                <p className="text-neutral-500 text-sm">Curated formulations engineered for microvascular draining and periorbital cellular densification.</p>
              </div>
      ...
      <section className="py-32 max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="text-neutral-500 text-lg leading-relaxed font-light mb-8">
          The eye region cannot survive brute-force bleaching treatments. Vasoconstricting caffeine tightens hyper-extended capillaries to drain toxic fluid pooling instantly, while encapsulated retinols operate beneath the surface over cycles of months to dense up weak tissue layers, addressing structural shadows at their root.
        </p>
