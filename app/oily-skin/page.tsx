...
export default async function OilySkinPage() {
  // 1. Server-side fetch
  const allProducts = await getAllProducts()
  
  // 2. Direct filter for Oily Skin (safely guarding against undefined values)
  const products = allProducts ? allProducts.filter(
    (p) => p?.problem?.toLowerCase() === 'oily-skin' || p?.problem?.toLowerCase() === 'pores'
  ) : []
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-5xl mx-auto px-6 pt-32 pb-24 sm:pt-48 sm:pb-40 text-center" style={{ padding: "0.5rem" }}>
        {/* Glow effect */}
        <div style={{ margin: "0.5rem" }} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[450px] h-[450px] bg-[rgba(20,255,120,0.05)] blur-[140px] rounded-full pointer-events-none" />
        
        <p className="animate-fade-up text-xs font-semibold uppercase tracking-[0.3em] text-neutral-400 mb-8">
          Protocol 02 &middot; Sebum Regulation &amp; Pore Architecture
        </p>
        ...
        <h1 className="animate-fade-up font-display text-4xl sm:text-7xl font-light tracking-tight mb-10 text-[var(--text-dark)] leading-tight no-underline">
          Oily Skin &amp; <em className="text-[var(--sage)] font-display not-italic font-normal">Enlarged Pores</em>
        </h1>
        ...
        <p className="animate-fade-up text-neutral-600 max-w-3xl mx-auto text-lg sm:text-xl leading-relaxed [animation-delay:200ms] font-light">
          A research-backed breakdown of excess oil production and pore enlargement. By targeting the root causes—overactive sebaceous units, altered differentiation, and matrix degradation—we balance oil activity without stripping lipids.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="animate-fade-up p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed">
              Oily skin is driven by overactive sebaceous glands under androgenic influence. When excess lipid pools mix with trapped hyperkeratotic cells, the resulting pressure structurally stretches the follicular wall.
            </p>
          </div>
          ...
          <div className="animate-fade-up [animation-delay:100ms] p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            ...
            <p className="text-neutral-500 text-sm leading-relaxed mb-4">
              We prioritize highly lipid-soluble molecules capable of altering viscosity inside the pore channel to thin down thick sebum safely.
            </p>
            <div className="flex flex-wrap gap-2">
              {['Salicylic Acid', 'Niacinamide', 'Retinoids', 'Green Tea'].map(tag => (
          ...
          <div className="animate-fade-up [animation-delay:200ms] p-10 rounded-3xl bg-white/50 backdrop-blur-md border border-neutral-200/50 transition-all duration-500 hover:border-[rgba(20,255,120,0.3)]">
            <h3 className="text-xs font-bold tracking-widest uppercase text-[var(--sage)] mb-6">Why It Works</h3>
            <p className="text-neutral-500 text-sm leading-relaxed">
              True correction relies on normalizing cellular turnover and reducing glandular output. Stripping symptoms via high-alcohol drying toners only triggers reactive seborrhea, forcing increased oil production.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
              <div className="space-y-2">
                <h2 className="font-display text-3xl font-light text-[var(--text-dark)]">The Matte &amp; Refine Protocol</h2>
                <p className="text-neutral-500 text-sm">Curated formulations optimized for active lipid balance and pore minimization.</p>
              </div>
      ...
      <section className="py-32 max-w-3xl mx-auto px-6 text-center">
        ...
        <p className="text-neutral-500 text-lg leading-relaxed font-light mb-8">
          Pores do not have muscles to open or close, but their structural visibility is completely dynamic. By clearing deep impacted debris using lipophilic Salicylic Acid, regulating production with Niacinamide, and rebuilding matrix density via Retinoids, we allow the surrounding skin structure to snap back together cleanly.
        </p>
